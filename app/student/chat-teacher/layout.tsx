    ...
    <>
      <div className="w-full h-[calc(100vh-16px)] bg-transparent shadow rounded-lg sticky top-2 flex flex-col border overflow-hidden">
        <div className="h-full w-full overflow-y-auto flex">
          <div className="sticky min-w-xs max-w-xs w-xs h-full top-0 overflow-y-auto flex flex-col border-r overflow-hidden">
            <div className="sticky z-10 top-0 border-b w-full p-4 bg-primary-foreground flex flex-col gap-y-3">
          ...
          <div className="flex flex-col w-full h-full overflow-hidden">
            ...
            <div className="w-full overflow-y-auto grow p-4 flex flex-col gap-y-4">
              <Message align="end">
                ...
                <MessageContent>
                  <Bubble>
                    <BubbleContent className="text-base flex flex-col gap-y-2">
                      <p>
                        Hi Sir, I the vectors question again — can you take me
                        through it again?
                      </p>
                    </BubbleContent>
                  </Bubble>
              ...
              <Message>
                ...
                <MessageContent>
                  <Bubble variant={"secondary"}>
                    <BubbleContent className="text-base flex flex-col gap-y-2">
                      <p>No worries, you&apos;re the reason I&apos;m here</p>
                    </BubbleContent>
                  </Bubble>
                </MessageContent>
              </Message>
              <Message>
                ...
                <MessageContent>
                  <Bubble variant={"secondary"}>
                    <BubbleContent className="text-base flex flex-col gap-y-2">
                      <p>
                        No worries. Draw the vector, then drop a line straight
                        down to the x-axis — that gives you the horizontal and
                        vertical parts.
                      </p>
                    </BubbleContent>
                  </Bubble>
              ...
              <Message>
                ...
                <MessageContent>
                  <Bubble variant={"secondary"}>
                    <BubbleContent className="text-base flex flex-col gap-y-2">
                      <p>
                        Try resolving the vector into x and y components first.
                      </p>
                    </BubbleContent>
                  </Bubble>
                </MessageContent>
              ...
              <Message align="end">
                ...
                <MessageContent>
                  <Bubble>
                    <BubbleContent className="text-base flex flex-col gap-y-2">
                      <p>Yes sir, I&apos;ll let you know the final results.</p>
                    </BubbleContent>
                  </Bubble>
                </MessageContent>
              </Message>
              ...
              <Message>
                ...
                <MessageContent>
                  <Bubble variant={"secondary"}>
                    <BubbleContent className="text-base flex flex-col gap-y-2">
                      <p>I will wait on your response</p>
                    </BubbleContent>
                  </Bubble>
                </MessageContent>
              </Message>
            </div>
            <section className="bottom-0 sticky w-full h-fit flex flex-col items-center gap-y-4 bg-white px-4 py-2">
